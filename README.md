...
```
yum -y install wget && cd /tmp && wget http://github.itzmx.com/ashq3/cdnbest/main/install/im.sh -O im.sh && sh im.sh 4.7.25 && ./cdnbest-master/shell/install.sh 10086 /vhs2
```
...
独立系统一键升级脚本:
```
cd /tmp && wget http://github.itzmx.com/ashq3/cdnbest/main/install/im.sh -O im.sh && sh im.sh 4.7.25 && ./cdnbest-master/shell/update.sh /vhs2
```
...
```
cd /tmp && wget http://github.itzmx.com/ashq3/cdnbest/main/install/im.sh -O im.sh && sh im.sh 4.6.16 && ./cdnbest-master/shell/update.sh /vhs2
```
...
安装命令：（复制下面命令到服务器上运行）
```
yum -y install wget;wget --no-check-certificate http://github.itzmx.com/ashq3/cdnbest/main/install/cb.sh -O cb.sh;sh ./cb.sh 10086
```
windows下载
